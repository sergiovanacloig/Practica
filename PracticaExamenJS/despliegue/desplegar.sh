...
docker run -d -p 3306:3306 --net=red_docker --ip 192.168.1.121 --name mysql_mierder -v /opt/mierder/sql/mysql -e MYSQL_ROOT_PASSWORD=root -v /opt/mierder/database:/database mysql
