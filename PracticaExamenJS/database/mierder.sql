...
-- Volcando datos para la tabla mierder.productos: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `productos` DISABLE KEYS */;
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `precio`, `imagen`, `id_categoria`) VALUES
	(1, 'LG', 'Pantalla', 50, 'images/lg.jpg', 1),
	(2, 'Samsung', 'Monitor', 30, 'images/samsung.jpg', 1),
	(3, 'Logitech', 'G403', 25, 'images/403.jpg', 2),
	(4, 'Korsair', 'k70', 10, 'images/k70.jpg', 4);
